"""
Django settings for integracaoapps project.
...
SECRET_KEY = '-3#q!*iu^uyh0u#72kmrv9yx$%g53k5d@h7317^ukaibcd(n1j'
...
ROOT_URLCONF = 'integracaoapps.urls'
...
WSGI_APPLICATION = 'integracaoapps.wsgi.application'
